...
- (void) initView
{
    ...
    [self.fileAttachButton setImage:[UIImage imageNamed:@"_jiver_btn_upload_off"] forState:UIControlStateNormal];
    [self.fileAttachButton setImage:[UIImage imageNamed:@"_jiver_btn_upload_on"] forState:UIControlStateHighlighted];
    [self.fileAttachButton setImage:[UIImage imageNamed:@"_jiver_btn_upload_on"] forState:UIControlStateSelected];
...
- (void) setDelegate:(id<ChatMessageInputViewDelegate, UITextFieldDelegate>)delegate
{
    _delegate = delegate;
