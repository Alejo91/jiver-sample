...
public class JiverChannelListActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jiver_channel_list);
        ...
        Jiver.queryMessagingUnreadCount().get(new MessagingUnreadCountQuery.MessagingUnreadCountQueryResult() {
            @Override
    ...
    private void initFragment(String channelUrl) {
        mJiverChannelListFragment = new JiverChannelListFragment(channelUrl);
        mJiverChannelListFragment.setJiverChannelListHandler(new JiverChannelListFragment.JiverChannelListHandler() {
            @Override
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.fragment_container, mJiverChannelListFragment)
                .commit();
    }
    ...
    private void initUIComponents() {
        ...
        mBtnSettings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(JiverChannelListActivity.this)
                        .setTitle("JIVER")
    ...
    public static class JiverChannelListFragment extends Fragment {
        ...
        public static interface JiverChannelListHandler {
            public void onChannelSelected(Channel channel);
        }

        public void setJiverChannelListHandler(JiverChannelListHandler handler) {
            mHandler = handler;
        }

        public JiverChannelListFragment() {
        }

        public JiverChannelListFragment(String channelUrl) {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.jiver_fragment_channel_list, container, false);
            initUIComponents(rootView);
            mChannelListQuery = Jiver.queryChannelList();
        ...
        private void initUIComponents(View rootView) {
            ...
            mAdapter = new JiverChannelAdapter(getActivity());
            mSearchAdapter = new JiverChannelAdapter(getActivity());
        ...
        private void search(String keyword) {
            ...
            mChannelListSearchQuery = Jiver.queryChannelList(keyword);
            mChannelListSearchQuery.next(new ChannelListQuery.ChannelListQueryResult() {
                @Override
                public void onResult(Collection<Channel> channels) {
        ...
        public static class JiverChannelAdapter extends BaseAdapter {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if(convertView == null) {
                    ...
                    convertView = mInflater.inflate(R.layout.jiver_view_channel, parent, false);
                ...
                if(item.getUrl().equals(Jiver.getChannelUrl())) {
