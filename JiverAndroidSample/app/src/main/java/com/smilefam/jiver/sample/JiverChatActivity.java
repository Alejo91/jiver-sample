...
public class JiverChatActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jiver_chat);
    ...
    private void initFragment() {
        ...
        mJiverChatAdapter = new JiverChatAdapter(this);
        mJiverChatFragment.setJiverChatAdapter(mJiverChatAdapter);

        mJiverChatFragment.setJiverChatHandler(new JiverChatFragment.JiverChatHandler() {

            @Override
            public void onChannelListClicked() {
                Intent intent = new Intent(JiverChatActivity.this, JiverChannelListActivity.class);
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.fragment_container, mJiverChatFragment)
                .commit();
    }
    ...
    private void initJiver(Bundle extras) {
        ...
        Jiver.setEventHandler(new JiverEventHandler() {
            ...
            public void onMessageReceived(Message message) {
                mJiverChatAdapter.addMessageModel(message);
            }

            @Override
            public void onSystemMessageReceived(SystemMessage systemMessage) {
                mJiverChatAdapter.addMessageModel(systemMessage);
            }

            @Override
            public void onBroadcastMessageReceived(BroadcastMessage broadcastMessage) {
                mJiverChatAdapter.addMessageModel(broadcastMessage);
            }

            @Override
            public void onFileReceived(FileLink fileLink) {
                mJiverChatAdapter.addMessageModel(fileLink);
            }
    ...
    private void initUIComponents() {
        ...
        mBtnLeave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mSettingsContainer.setVisibility(View.GONE);
                Jiver.leave(Jiver.getChannelUrl());
                finish();
            }
        });
    ...
    public static class JiverChatFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.jiver_fragment_chat, container, false);
...
//                            Jiver.loadPrevMessages(30);
        ...
        public void setJiverChatAdapter(JiverChatAdapter adapter) {
            mAdapter = adapter;
            if(mListView != null) {
            ...
            if(convertView == null || ((ViewHolder)convertView.getTag()).getViewType() != getItemViewType(position)) {
                ...
                switch(getItemViewType(position)) {
                    ...
                    case TYPE_MESSAGE: {
                        ...
                        convertView = mInflater.inflate(R.layout.jiver_view_message, parent, false);
                    ...
                    case TYPE_FILELINK: {
                        ...
                        convertView = mInflater.inflate(R.layout.jiver_view_filelink, parent, false);
